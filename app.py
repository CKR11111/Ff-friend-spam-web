...
# NEW API CONFIG (Hugging Face Space)
FRIEND_API = "https://ckrunknown-ff-api-req.hf.space/add_friend"

def run_spam_in_background(accs, target):
    async def process():
        # कनेक्सन लिमिट १०० सम्म (For High Speed)
        connector = aiohttp.TCPConnector(limit=100, ssl=False)
        async with aiohttp.ClientSession(connector=connector) as session:
            # ५० वटा रिक्वेस्ट एकैसाथ पठाउने
